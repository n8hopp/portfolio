const styles = {
  ...
  sectionHeadText:
    'text-coolGrey font-regular md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] font-fira',
  sectionHeadTextLight:
    'text-timberWolf font-medium md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] font-poppins',
  sectionSubText:
